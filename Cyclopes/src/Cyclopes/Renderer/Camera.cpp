...
namespace cyc {
	...
	{
		glm::vec3 rawfront;
		rawfront.x = glm::cos(glm::radians(Yaw)) * glm::cos(glm::radians(Pitch));
		rawfront.y = glm::sin(glm::radians(Pitch));
		rawfront.z = glm::sin(glm::radians(Yaw)) * glm::cos(glm::radians(Pitch));
