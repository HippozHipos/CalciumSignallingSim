...
namespace cyc {
	...
	public:
		void ErrorMessageBox(CycWString error);
	...
	private:
		...
		mutable CycQueue<WindowEvent> m_EventBuffer;

	private:
		LayerStack& layers;
		static int s_WindowCount;
		CycWString m_ClassName = L"Cyclopes Window";
	...
	private:
		...
		CycUnique<Win32NativeWindow> m_Window;
		LayerStack m_Layers;
